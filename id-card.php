<?php 
        ...
        if(isset($_POST['search'])){
             ...
             $sql = "Select * from cards where Ration_Card_Number='$Ration_Card_Number' ";
...
<html lang="en">
  <head>
    ...
    <title>Card Generation | E-Ration Card System</title>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-image: linear-gradient(to right, rgb(0,300,255), rgb(93,4,217));">
  <a class="navbar-brand" href="#"><img src="assets/images/codingcush-qr-code (1)" alt=""></a>
  ...
  <div class="col-sm-6">
    <div class="card jumbotron">
      <div class="card-body">
        ...
        <input class="form-control mr-sm-2" type="search" placeholder="Enter Ration Card No." name="id_no">
        <small id="emailHelp" class="form-text text-muted">Every Family should have unique Ration Card no.</small>
        <br>
...
<hr>
<button id="demo" class="downloadtable btn btn-primary" onclick="downloadtable()"> Download Ration Card</button>
    <!-- Optional JavaScript -->
