...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $Ration_Card_Number = $_POST["id_no"];
    $Family_Members = $_POST['grade'];
    $Allotted_Date = $_POST['dob'];
    $address = $_POST['address'];
    $Family_id = $_POST['email'];
    $exp_date = $_POST['exp_date'];
    $phone = $_POST['phone'];

    if($Card_Holder_Name == '' || $Ration_Card_Number == ''){
        $empty = true;
    }
    else{
        //Check that Card no. is Already Registerd or not.
        $querry = mysqli_query($conn, "SELECT * FROM cards WHERE Ration_Card_Number= '$Ration_Card_Number' ");
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`Card_Holder_Name`, `Ration_Card_Number`, `Family_id`, `phone`, `address`, `Allotted_Date`, `exp_date`, `image`) VALUES ('$Card_Holder_Name','$Ration_Card_Number','$Family_id]','$phone','$address','$Allotted_Date','$exp_date','$uploadfile')"; 
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc">Ration Card Number:</label>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        <label for="inputState">Family Member's</label>
      ...
      <div class="form-group col-md-2">
        <label for="inputZip">Allotted Date</label>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        <label for="inputState">Family Id</label>
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
          <label for="id_no">Ration Card No.</label>
  ...
  <hr>
  <a href="https://github.com/PorwalAnand" type="button" class="btn btn-primary btn-lg btn-block" target="_blank">E - RATION CARD SYSTEM</a>
  <!-- Optional JavaScript -->
